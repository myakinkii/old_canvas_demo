...
function crDiv(id,cN,children,events,context)
{return crEl('div',id,cN,children,events,context);}
...
function invoke(func,context)
{return function(){func.call(context)}}

function timer(context,func,timeOut)
{return window.setTimeout(function(){return func.call(context)},timeOut)}

function interval(context,func,timeOut)
{return window.setInterval(function(){return func.call(context)},timeOut)}
...
while(getId("alert"+id))
{id="alert"+Math.round(10000*Math.random());}
al.id=id;
with (al.style)
{
zIndex="2";
